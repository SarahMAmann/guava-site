      ...
      <div className="bg-transparent pt-12">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-4xl">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl flex pb-6">
                <SparkleIcon className="h-7 w-7 pr-2"/>Selected Client Work</h2>
                ...
                <article key={post.id} className="relative isolate flex flex-col gap-8 lg:flex-row">
                  ...
                  <div>
                    ...
                    <div className="group relative max-w-xl">
                      <h3 className="mt-3 text-lg font-semibold leading-6 text-lime-400">
